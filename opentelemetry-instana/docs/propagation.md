...
```rust
propagator = InstanaPropagator::new();
```
...
A short summary for each of the headers is provided below. More details are available at <https://www.ibm.com/docs/en/instana-observability/latest?topic=monitoring-traces#tracing-headers>.
...
* For more information on Instana, visit <https://www.instana.com/> and the [Instana documentation](https://www.ibm.com/docs/en/instana-observability/latest).
