...
pub struct InstanaExporterOptions {
    pub endpoint: String,
    pub hostname: String,
...
impl Default for InstanaExporterOptions {
    fn default() -> Self {
...
impl Default for InstanaExporter {
    fn default() -> Self {
        let options = InstanaExporterOptions::default();
...
impl SpanExporter for InstanaExporter {
...
impl Builder {
    ...
    pub fn with_options(mut self, options: InstanaExporterOptions) -> Self {
    ...
    pub fn build(self) -> Result<InstanaExporter, BuildError> {
...
impl InstanaExporter {
    pub fn builder() -> Builder {
        Builder {
            exporter: InstanaExporter::default(),
        }
    }
    ...
    pub fn get_options(&self) -> InstanaExporterOptions {
        self.options_.clone()
    }

    pub fn new(client: Arc<dyn HttpClient>, options: InstanaExporterOptions, resource: Resource) -> Self {
        Self {
            options_: options,
