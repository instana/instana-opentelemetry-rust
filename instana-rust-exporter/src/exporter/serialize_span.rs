...
pub fn convert_to_instana_span(exporter: &Exporter, span: &SpanData) -> Result<InstanaSpan> {
...
fn build_data_section(exporter: &Exporter, span: &SpanData) -> Result<InstanaSpanData> {
...
fn build_from_section(exporter: &Exporter) -> InstanaSpanFrom {
...
pub fn serialize_batch(exporter: &Exporter, batch: &[SpanData]) -> Result<bytes::Bytes> {
